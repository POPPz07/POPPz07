## 👋 Hi, I'm Virendra Pawar (aka POPPz07)

🎓 Final-year **Computer Engineering** student at **SPPU (2022–2026)**  
💻 Backend / Full-Stack Engineer • Applied AI/ML • Cloud Fundamentals  
📈 Building **reliable APIs, intelligent ML systems, and scalable applications**

---

## 🚀 What I’ve Built

I focus on **backend-heavy, ML-powered systems** that solve real problems:

- **TruthLens** — Misinformation detection platform using LLMs, cloud search, and ML-based verification  
- **Code Vulnerability Detection System** — AST-based static code analysis using ML to detect insecure patterns  
- **Media Investment Optimizer (NetElixir AIgnition)** — ML-driven budget allocation system for paid media optimization  
- **Hybrid Movie Recommendation System** — Full-stack recommender using TF-IDF, cosine similarity, and SVD  
- **Student Face Tracking System** — Real-time tracking using YOLOv8, DeepSORT, and InsightFace  
- **Student Attendance System** — Face-recognition-based automated attendance using Streamlit  
- **AI Hiring Assistant** — Intelligent candidate screening and evaluation tool  
- **Smart LeadGen AI Tool** — Automated AI-powered business lead qualification platform  
- **E-commerce Aggregator** — Web scraping, ETL pipelines, REST APIs for product comparison  
- **Tourist Geo Safety App** — Location-based safety alerts and geospatial insights  
- **Smart Vacuum Robot Controller** — Web-based controller for ESP8266-powered vacuum robot  
- **Airbnb Insights Dashboard** — Streamlit dashboard for analyzing Airbnb booking trends  

👉 Overall specialization: **backend systems, ML pipelines, data workflows, and applied AI**.
...
- Built **3D graph visualizers** using Babylon.js and Neo4j  
- Integrated search APIs and ML/LLM-based classifiers  
- Implemented JWT authentication and backend services  

---

## 🏆 Highlights (Brief)

- 🏅 **Top 10 Nationwide — NetElixir AIgnition Hackathon**  
- 🥇 **1st Place — Technosphinx Ideathon**  
- 🧠 Semi-finalist in national-level hackathons  
- 🎯 Strong focus on **applied ML, backend systems, and execution**

---

## 🔝 Top Contributed Repositories

![Top Repos](https://github-contributor-stats.vercel.app/api?username=POPPz07&limit=6&theme=dark&combine_all_yearly_contributions=true)
...
> Every repository reflects progression, not repetition.
